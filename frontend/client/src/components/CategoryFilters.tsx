              ...
              <Dialog.Panel
                ...
                <form className="mt-4 border-t border-gray-200">
                  ...
                  <div className="px-4">
                    <button
                      type="submit"
                      className="mt-8 w-full bg-gray-900 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900"
                    >
                      Apply Filters
                    </button>
                  </div>
