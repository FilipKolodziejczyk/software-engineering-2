    ...
    return (
      <div className="w-1/6 p-4 bg-gray-100">
            ...
            <div className="flex flex-col items-center mt-20">
                <Link to="/products">
                <button
                    className={`rounded-lg py-2 px-4 mx-auto border-2 block ${clickedButton==1 ? 'border-fuchsia-300' : ''} ${clickedButton==1 ? 'bg-fuchsia-300 text-gray-100' : 'bg-gray-100 text-gray-950'}`}
                ...
                <Link to="/complaints">
                <button
                    className={`rounded-lg py-2 px-4 mt-8 mx-auto border-2 block ${clickedButton==3 ? 'border-fuchsia-300' : ''} ${clickedButton==3 ? 'bg-fuchsia-300 text-gray-100' : 'bg-gray-100 text-gray-950'}`}
